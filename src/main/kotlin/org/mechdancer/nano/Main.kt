...
fun test() {
    val data = MotorStatePacket(Array(6) { Motor.State.Break })
    ...
    val data4 = EncoderResetPacket
    require(EncoderResetPacket.serializer.fromByteArray(EncoderResetPacket.serialize()) == data4)
}
